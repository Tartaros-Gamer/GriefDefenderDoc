...
5 30
```
This example means that you will charge a minimum of ***500*** to start the rental (5 x 100) which will give the user 5 hours already paid and your claim will be available for rent up to **30 days.**  
